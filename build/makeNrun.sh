...
i386-elf-gcc -ffreestanding -m32 -g -c ../src/string.c -o ./objfiles/string.o
nasm ../src/isrhandler.asm -f elf -o ./objfiles/isrhandler.o
nasm ../src/kernel_entry.asm -f elf -o ./objfiles/kernel_entry.o
i386-elf-ld -o ./binfiles/full_kernel.bin -Ttext 0x1000 ./objfiles/kernel_entry.o ./objfiles/kernel.o ./objfiles/vga_driver.o ./objfiles/ports.o ./objfiles/idt.o ./objfiles/isr.o ./objfiles/isrhandler.o ./objfiles/keyboard.o ./objfiles/shell.o ./objfiles/string.o --oformat binary
