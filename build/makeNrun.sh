...
i386-elf-gcc -ffreestanding -m32 -g -c ../src/ports.c -o ports.o
...
i386-elf-ld -o full_kernel.bin -Ttext 0x1000 kernel_entry.o kernel.o vga_driver.o ports.o idt.o isr.o isrhandler.o --oformat binary
